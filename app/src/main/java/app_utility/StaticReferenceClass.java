...
public class StaticReferenceClass {
    ...
    public static final String SERVER_URL = "18.222.197.80";//"autochipars.odoo.com";//"192.168.1.100";//"192.168.1.46";//"192.168.42.192";//"192.168.1.41";//https://
    public static final int PORT_NO = 8069;//9040;//

    public static final String MODEL_FLEET_VEHICLE = "fleet.vehicle";

    public static final String DB_NAME = "ARS";//"chellaminfotech-ars-master-73173";//"ARS_9040";//"test_db";//"auto";//
    public static final String USER_ID = "suresh";//"vijay@gmail.com";//"vijay.eh4@gmail.com";//"admin";//
